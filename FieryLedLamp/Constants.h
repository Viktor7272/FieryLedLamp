// Текущая версия v2.12_web_v1.7  ( gunner47_v2.12_web_v1.7_87in1 )
...
#define BUTTON_CAN_SET_SLEEP_TIMER                          // с этой строчкой, если на выключенной лампе набить кнопкой "нажатие + нажатие с удерживанием", лампа мигнёт синим и включится,
                                                            // а Таймер выключения лампы будет установлен на последнее выставленное для этого в приложении время. чтобы убрать эту функцию, удалите или закомментируйте строчку
